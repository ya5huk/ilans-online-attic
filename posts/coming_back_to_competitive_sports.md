...
- 3-bounds jump: 8.88m
- 5-bounds jump: 15.10m

- 60m PB: 7.33s
- 100m PB: 11.21s
- LJ PB: 6.75m (6.80w)

- Clean PB: 95kg (from last week)
- Squat: Can do 130kg, no real PB
- Bench: PB 80kgX6 (Feb 2025)
...
- [Visuathlete](https://visuathlete.com) - A site to visualize results for all Israeli athletes
- [EL-ON](https://el-on.co.il/) - A site I made for a client
...
2. Strengthen everything - core, hips, feet, upper body, etc.
3. Just running. Running at pretty high speeds and a few long runs. I wanted to see how my body will handle moving so much after a year without much of fast running.
4. Getting more powerful & stronger (gym)
...
I started running faster and started doing more explosive work (bound jumps, jumping with weights, single leg jumps, etc.). I ran on stairs twice. I did my first tests to understand where I am standing in comparison with last year. _You can see the results under the October headline_.
...
- Gym becomes heavier ([PB'ed the clean a week ago](https://youtube.com/shorts/uIuxgEfTQxk?si=k-QYDKjlMWNnUfTM) - 95kg!!)
- I started going to physiotherapy to get rid of hamstring pain
  (= Everyday exercises for hamstring & hips)
